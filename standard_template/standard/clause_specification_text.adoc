...
This specification uses ideas and sentence structures from the http://geojson.org/geojson-spec.html[GeoJSON specification] which is licensed under a http://creativecommons.org/licenses/by/3.0/usCreative Commons Attribution 3.0 United States License].
