...
Embedding the data values of all variables in a Coverage object within the CoverageJSON document is the simplest and most common use case. Such a "standalone" document supports the use of very simple clients.
